...
/// Baby ApeCoin
contract Baby ApeCoin is ERC20("Baby ApeCoin", "Baby Ape"), Ownable {
    ...
    /// We need mint some Baby Ape in advance
    uint256 public BabyApeInAdvance;
    ...
    /// @notice We need mint some Baby Ape in advance
    constructor() public {
        treasuryWalletAddr = _msgSender();
        BabyApeInAdvance = 10000 * 10**6 * 10**18;

        mint(treasuryWalletAddr, BabyApeInAdvance);
    }
    ...
    function transferBabyApeByOwner(address _to, uint256 _amount) external onlyOwner {
